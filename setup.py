...
def get_extension() -> Extension:
    ...
    extra_compile_args = {
        "cxx": ["-fdiagnostics-color=always", "-DPy_LIMITED_API=0x030C0000", "-O3"],
        "nvcc": ["-O3"],
    }
    ...
    return extension("fastabx._C", sources, extra_compile_args=extra_compile_args, py_limited_api=True)
